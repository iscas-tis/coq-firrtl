...
where \ding{51} indicates that the same values of the output ports and \ding{55}(n) indicating some values of the output ports of $n$ benchmarks are different.
The last row (Average) shows the average results over all 201 benchmarks.
Detailed results are given in the supplementary material.
