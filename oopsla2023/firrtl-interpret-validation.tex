...
and design two additional LoFIRRTL circuits in consideration of the branch coverage of the LoFIRRTL OCaml Interpreter and different hierarchical structures of the modules.
...
Overall, our LoFIRRTL OCaml Interpreter successfully executes all the 120 benchmarks
...
In terms of efficiency, our LoFIRRTL OCaml Interpreter is significantly faster (6.95 times on average) than Treadle on almost all the benchmarks
...
All the 120 benchmarks together cover all the 51 branches. (Note that only 36 out of 51 branches are covered without our own two benchmarks.)
