...
\paragraph{ExpandConnects} The ExpandConnects pass expands the connect and partial connect statements. For instance, 

\paragraph{ExpandWhens} that expands the when statements, 

\paragraph{LowerTypes} that lower down the aggregate types, i.e. bundle and vector types, 
