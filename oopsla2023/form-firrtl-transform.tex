...
set of components defined with the paired
identifiers and of ground types.
After applying the Expand Connections pass, connect
statements are already in ground types. The references in these
statements need to be replaced by the corresponding paired
identifiers. As a result, both the statements $ss$ in the circuit diagram and
the components environment $ce$ are changed coordinately.
