...
The pass focuses on connection statements in $ss$. The left-hand side
...
Expanding a \prettyll{mux} expression is done by {\tt expand\_mux} function,
  \begin{gather}
    \infer[]
...
expressions $e1$ and $e2$ as inputs, and then produces a list
of \prettyll{mux} that combines the lists of expanded $e1$ and $e2$
with the same condition.  Expanding a references is relatively straightforward.
