...
After applying the Infer Types pass, types with an implicitly defined width are assigned width 0 in $ce$.
...
types.  The pass begins by scanning through the statements in $ss$ and
searching the component environment $ce$ for
abstract reset types to be added to $rm$.
