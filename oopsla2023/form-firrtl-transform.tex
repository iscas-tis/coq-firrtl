...
\xiaomu{whether validif is in the syntax}
...
expressions $e_1$ and $e_2$ from the original \prettyll{mux} expression, and then produces a list $es_{mux}$
of \prettyll{mux} that combines the lists of expanded $e_1$ and $e_2$
with the same condition $e_c$. Expanding a references is relatively straightforward.
