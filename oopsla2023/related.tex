...
that translates programs in in high-level software or hardware programming languages into low-level and/or optimized code~\cite{Dave03}.
...
\cite{Chlipala07,Chlipala10} formalized and proved compilers that translate programs in simply-typed or untyped lambda calculus to code an idealized assembly language.
...
The closest work to ours is~\cite{HarrisonHA21} who formalized a coinductive denotational semantics in Agda for an idealized subset of LoFIRRT based on a formalism called device calculus.
