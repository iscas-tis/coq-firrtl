...
The earliest work in compiler verification dates to 1967,
...
single compilation pass to sophisticated code optimizations of compilers for both software and hardware programming languages~\cite{Dave03,HerklotzPRW21}.



Verified compilation for software programming languages
...
executable compilers can be automatically
generated (cf. \cite{Awesomecoq} for a curated list).
...
Verified Compilation of Hardware Languages.

Translation validation proves equivalence between
the input program and the output design~\cite{PnueliSS98}.
