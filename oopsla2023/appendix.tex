...
\section{Missing details in Section~\ref{sec-lofirrtl-sem}}

\paragraph*{The definitions of $te(e)$ and $s(e)$} 
%
For $\theta \bwidth{n}(n')$ such that $\theta \in \{UInt, SInt\}$, $n > 0$, and $n'$ is an integer, we define $bv_{\theta \bwidth{n}(n')}$ as follows. 
\begin{itemize}
