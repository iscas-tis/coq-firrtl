...
\item let ${\tt type\_of\_expr}(e_1)=t_1$ and ${\tt type\_of\_expr}(e_2)=t_2$, then ${\tt type\_of\_expr}(\mbox{\prettyll{mux}}(e_0,e_1,e_2))={\tt max\_width}(e_1,e_2)$, where the {\tt max\_width} compute recursively the max width of the (sub)components, iff $t_1$ $t_2$ are type equivalent.
