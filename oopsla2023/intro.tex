...
\begin{itemize}
\item Define an executable operational semantics for LoFIRRTL. The operational semantics is based on a concept of pseudo-single-static-assignment form of LoFIRRTL programs.
%
...
%
\item Specify and verify the functional correctness of the two most involved lowering transformations, namely ``ExpandConnects'' and ``ExpandWhens''.
\end{itemize}
