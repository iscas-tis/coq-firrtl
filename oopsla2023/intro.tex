...
\end{itemize}
The establishment of a general framework for reasoning about programs in FIRRTL and its lowering transformations lays down a solid foundation towards a fully verified compiler for FIRRTL.
