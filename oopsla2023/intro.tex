...
%
\item Validate the operational semantics against Treadle, the main-stream FIRRTL reference interpreter, on a benchmark suite comprising \fu{121} LoFIRRTL programs.
%
\item Introduce a concept of circuit diagrams  and formalize the syntax of HiFIRRTL and its seven lowering transformations \fu{in Coq}, namely, ``InferTypes'', ``InferWidths'', ``InferResets'', ``ExpandConnects'', ``ExpandWhens'', ``LowerTypes'', and ``RemoveResets''.
%
