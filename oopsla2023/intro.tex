...
\begin{itemize}
\item Define an executable operational semantics for LoFIRRTL \fu{in Coq}. The operational semantics is based on a concept of pseudo-single-static-assignment form of LoFIRRTL programs.
%
...
%
\item Introduce a concept of circuit diagrams  and formalize the syntax of HiFIRRTL and its six lowering transformations \fu{in Coq}, namely, ``InferTypes'', ``InferWidths'', ``InferResets'', ``ExpandConnects'', ``ExpandWhens'', ``LowerTypes''.
