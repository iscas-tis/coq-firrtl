...
are not included in $\ccpnts(A)$.
(If a register is not connected to, then it keeps the current value.)
...
To have a well-defined semantics, we also assume that each component $z \in \ccpnts(A)$ should be connected to exactly once, that is,
