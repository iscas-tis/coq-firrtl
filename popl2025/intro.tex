...
Chisel~\cite{BachrachVRLWAWA12} is a domain specific language embedded in Scala that comprises a library of special class definitions, predefined objects, and usage conventions for writing highly-parameterized hardware design generators.
...
\tl{emphasise that HiFIRRTL is underspecification and the transformation can be viewed as a refinement process.}
