...
As such, the semantics of $M$, i.e., $\llbracket M\rrbracket$,  is interpreted as the set of {\lofirrtl} modules $(tm,cm)$ such that $(tm, cm)\models M$.
The main challenge is that there is an abstraction-level gap between {\hifirrtl} and {\lofirrtl} programs:
