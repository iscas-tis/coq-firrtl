...
the interactive theorem prover Coq. In total, 7,333 lines of Coq code are used for specifying the syntax and semantics of {\hifirrtl} programs, and 14,450 lines of Coq code are used for the formalization of the three lowering transformations and their correctness proofs. 
