...
requires at least (1) a mechanized semantics of both {\hifirrtl} and {\lofirrtl},
...
The transformations can be viewed as a refinement process, and eventually produce an ``optimal" {\lofirrtl} program, which should respect all the constraints of the {\hifirrtl} program but also admits the lowest bit-widths.
...
the interactive theorem prover Coq. In total, 22,703 lines of Coq code are used for specifying the syntax and semantics of {\hifirrtl} programs, and 14,450 lines of Coq code are used for the formalization of the three lowering transformations and their correctness proofs. 
