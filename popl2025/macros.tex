...
\newcommand{\range}[1]{\mathtt{range}(#1)}
\newcommand{\astring}{s}
...
\newcommand{\firrtl}{\textrm{FIRRTL}}
\newcommand{\hifirrtl}{\textrm{HiFIRRTL}}
\newcommand{\lofirrtl}{\textrm{LoFIRRTL}}
...
\newcommand\idset{\mathsf{ID}}
\newcommand\gidset{\mathsf{GID}}
...
\newcommand{\seqq}[1]{\seq{\ifx#1\relax\else#1\fi}}

\newcommand{\ruleName}[1]{\textrm{#1}}


\newcommand{\infernone}[2][]{%
	\AxiomC{}
...
%\newcommand{\uint}[1]
%{
%\mbox{\prettyll{UInt}}\mbox{<}#1\mbox{>}
%}

%\newcommand{\sint}[1]
%{
%\mbox{\prettyll{SInt}}\mbox{<}#1\mbox{>}
%}
...
\newcommand\iports{{\sf InPorts}}
\newcommand\oports{{\sf OutPorts}}
\newcommand\sports{{\sf SubPorts}}
\newcommand\siports{{\sf SubInPorts}}
\newcommand\soports{{\sf SubOutPorts}}
\newcommand\ports{{\sf Ports}}
\newcommand\wires{{\sf Wires}}
\newcommand\nodes{{\sf Nodes}}
\newcommand\registers{{\sf Regs}}
\newcommand\varset{{\sf Vars}}
\newcommand\cpnts{{\sf Cpnts}}
\newcommand\ccpnts{{\sf CCpnts}}
\newcommand\gtypes{{\sf GTypes}}
\newcommand\expgtypes{{\sf ExpGTypes}}
\newcommand\ftypes{{\sf FTypes}}
\newcommand\bv{{\sf BitVec}}
\newcommand\modinst{MI}

\newcommand\uint{{\sf UInt}}
\newcommand\sint{{\sf SInt}}
\newcommand\uintimp{{\sf UIntImp}}
\newcommand\sintimp{{\sf SIntImp}}
\newcommand\clock{{\sf Clock}}
\newcommand\reset{{\sf Reset}}
\newcommand\asyncreset{{\sf AsyncReset}}

\newcommand\duplex{{\sf duplex}}
\newcommand\sink{{\sf sink}}
\newcommand\source{{\sf source}}
\newcommand\gtype{{\sf ground}}
\newcommand\vtype{{\sf vector}}
\newcommand\btype{{\sf bundle}}
\newcommand\nil{{\sf nil}}

\newcommand\fieldseq{{\sf FldSeq}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\svnone}{{\sf none}}
\newcommand{\svundefined}{{\sf undefined}}
\newcommand{\svinvalid}{{\sf invalid}}
...
%%%%% functions
\newcommand{\madeexplicit}{{\sf madeExplicit}}
\newcommand{\madeexplicitfields}{{\sf madeExplicitFields}}
\newcommand{\typeeq}{{\sf typeEq}}
\newcommand{\sizeofftype}{{\sf sizeOfFtype}}
\newcommand{\sizeoffields}{{\sf sizeOfFields}}
\newcommand{\fadd}{{\sf add}}
\newcommand{\portsstmtstmap}{{\sf portsStmtsTmap}}
\newcommand{\portstmap}{{\sf portsTmap}}
\newcommand{\stmtstmap}{{\sf stmtsTmap}}
\newcommand{\stmttmap}{{\sf stmtTmap}}
\newcommand{\typeofref}{{\sf typeOfRef}}
\newcommand{\typeoffield}{{\sf typeOfField}}
\newcommand{\typeofexp}{{\sf typeOfExp}}
\newcommand{\updatecm}{{\sf updateCM}}
\newcommand{\updatecmref}{{\sf updateCMRef}}
\newcommand{\listgexp}{{\sf listGExp}}
\newcommand{\listgexpfields}{{\sf listGExpFields}}
\newcommand{\listgtype}{{\sf listGType}}
\newcommand{\listgtyperef}{{\sf listGTypeRef}}
\newcommand{\listgtypereffields}{{\sf listGTypeRefFields}}
\newcommand{\typecompatible}{{\sf typeCompatible}}
\newcommand{\typecompatiblefields}{{\sf typeCompatibleFields}}
\newcommand{\invalidateref}{{\sf invalidateRef}}
\newcommand{\mux}{{\sf mux}}
\newcommand{\combinebranches}{{\sf combineBranches}}
\newcommand{\expandbranch}{{\sf expandBranch}}
\newcommand{\expandwhens}{{\sf expandWhens}}
\newcommand{\expandconnects}{{\sf expandConnects}}
\newcommand{\expandref}{{\sf expandRef}}
\newcommand{\inferwidths}{{\sf inferWidths}}
\newcommand{\topsort}{{\sf topSort}}
\newcommand{\tycnmap}{{\sf tycnMap}}
\newcommand{\depgraph}{{\sf depGraph}}
\newcommand{\maxgtlist}{{\sf maxGTList}}
\newcommand{\detwidths}{{\sf detWidths}}
\newcommand{\fmap}{{\sf map}}
\newcommand{\fmaptwo}{{\sf map2}}
\newcommand{\fmapthree}{{\sf map3}}
\newcommand{\connstmts}{{\sf connStmts}}
\newcommand{\ispassive}{{\sf isPassive}}
\newcommand{\filter}{{\sf filter}}
\newcommand{\replacewidths}{{\sf replaceWidths}}
\newcommand{\madeimplicit}{{\sf madeImplicit}}
%\newcommand{\isflipped}{{\sf isFlipped}}

\newcommand{\firtool}{{\rm firtool}}
