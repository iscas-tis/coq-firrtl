...
The type environment $te$ and state $s$ are lift to expressions $e$ as usual, whose definitions can be found in the supplementary material. % Appendix~\ref{app-lofirrtl}.
