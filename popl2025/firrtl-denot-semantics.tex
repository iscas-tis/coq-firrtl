...
%   \quad
%   \\[1ex]
    \infer[stmt\_tmap: connect-normal]
    {\seqq{stmt\_tmap((tmap, scope), s, vm) = (tmap', scope')}}
    {
    \begin{array}{c}
      s = r <= e \\
...
%   \quad
%   \\[1ex]
    \infer[stmt\_tmap: invalid-normal]
    {\seqq{stmt\_tmap((tmap, scope), s, vm) = (tmap', scope')}}
    {
    \begin{array}{c}
      s = r \mbox{ is invalid} \\
...
%   \\[1ex]
   ...
   \quad
   \\[1ex]
    \infer[stmt\_tmap: register-normal-asyncreset]
    {\seqq{stmt\_tmap((tmap, scope), s, vm) = (tmap', scope')}}
    {
    \begin{array}{c}
   ...
   \quad
   \\[1ex]
    \infer[stmt\_tmap: register-normal-reset]
    {\seqq{stmt\_tmap((tmap, scope), s, vm) = (tmap', scope')}}
    {
    \begin{array}{c}
      s = \mbox{reg } x: t \ clk \mbox{ with: reset =>} (rsig, rval)  \\
