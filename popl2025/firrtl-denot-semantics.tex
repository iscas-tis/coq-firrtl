...
%    \forall n.\ 0 \le n < size\_of\_ftype(ft) \Rightarrow ct(v, n) = none \wedge ct'(v,n) = undefined \\
    ...
    {
    \begin{array}{c}
    vm = vm' \wedge id(r)=(v, m) \wedge  id(r')=(v', m') \wedge type\_of\_exp(r, tmap)= ft \ \wedge \\
     size\_of\_ftype(ft) = sz \wedge type\_of\_exp(r', tmap)= ft'\ \wedge \\
     list\_gexp(r, ft) = ls \wedge  list\_gexp(r', ft') = ls'  \\
