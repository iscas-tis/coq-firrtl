...
\begin{itemize}
\item $(ground, b, t)$ such that $b$ is a Boolean value denoting whether it is flipped or not and $t \in \gtypes$, 
%
...
\begin{table}[t]
  ...
  \begin{gather*}
    ...
    {
    \begin{array}{c}
    	ft = (ground, b, t) \wedge ft' = (ground, b, t)\ \wedge \\
    ...
    {
    \begin{array}{c}
    	ft = (vector, t[n]) \wedge ft' = (vector, t'[n])\ \wedge \\
    ...
    {
    \begin{array}{c}
    	ft = (bundle, f) \wedge ft' = (bundle, f')\ \wedge \\
...
\begin{table}[t]
  ...
  \begin{gather*}
    ...
    {
    \begin{array}{c}
    	 ft = (vector, t[n]) \wedge l = list\_gexp(e[0], t) = l0 ++ \cdots ++ list\_gexp(e[n-1], t)
    \end{array}
    }
    \\[1ex]
