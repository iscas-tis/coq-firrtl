...
Let us first define $\typeofexp(e, tmap)$, the type of $e$ with respect to $tmap$. 
%
...
Next, let us define the rules for the functions $\updatecm$, $\updatecmref$, and $\invalidateref$.
