...
%
\item $\typeofexp()$ requires to iteratively match the type of $id$ to find the same $fid$ and then to return the $ftype$ associated. If the field identifier $fid$ can not be found in the $btyp$ of the reference $id$ or the type of $id$ is not $btyp$, it returns $\bot$.
%
