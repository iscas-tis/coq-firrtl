...
The components in a {\hifirrtl} program may %not be of ground types. They can 
be of ground types, vector types or bundle types. Let us use $\ftypes$ to denote the set of these types, that is, $\ftypes$ comprises the elements of one of the following forms, 
\begin{itemize}
