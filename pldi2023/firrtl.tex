...
%
\item InferType that infer the types of components, e.g. wires, nodes, registers,
%
\item InferWidth that infer the bit-width of ground types,
%
\item InferReset that infers concrete resets, i.e. AsyncReset or UInt<1>,
%
\item ExpandConnect that expands the connect statements, 
%
\item ExpandWhen that expands the when statements, 
%
