...
Proof.
  ...
  (* invalid *)
  simpl; intros Hneq Heval. admit. (* TBD 组会确认过invalid实现方法后完成 *)
  (* when *)
...
Proof.
  ...
  intros. apply (Hhelper _ _ Hdclr _ _ _ _ H0) in H1; try done.
Admitted.
...
Proof.
  ...
  - (* combinational part *)
    ...
    * (* outport *) 
      ...
      specialize (Hcnct _ _ _ Hin _ _ Hevalss2 _ _ Hexists). rewrite -Hcnct; clear Hcnct Hevalss2.
