...
module MakeValStore =
 ...
 struct
     ...
     struct
      ...
      module Raw =
       struct
        ...
        | Leaf -> 0
        | Node (l, _, _, r, _) ->
          Stdlib.Int.succ (add (cardinal l) (cardinal r))
  ...
  module Lemmas = FMapLemmas(TE__5)

  (** val map2 :
      (bits option -> bits option -> bits option) -> t -> t -> t **)
