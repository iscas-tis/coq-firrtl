...
let pp_flip out fl = 
  match fl with
  | Flipped -> output_string out "flipped "
  | Nflip -> output_string out "nflip "
...
let rec pp_type out ty = 
  ...
  | Btyp btyp -> output_string out "(Btyp "; pp_btyp out btyp; output_string out ")";

and pp_btyp out ty = 
  match ty with
  | Fnil -> output_string out "Fnil"
  | Fflips (v, fl, ft, ff) -> output_string out "("; output_string out (v^": "); pp_flip out fl; pp_type out ft; output_string out "; "; pp_btyp out ff; output_string out ")"
