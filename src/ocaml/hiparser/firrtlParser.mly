...
%token CIRCUIT STM_MODULE STM_PUBMODULE STM_EXTMODULE STM_SKIP STM_INPUT STM_OUTPUT STM_WHEN STM_ELSE  STM_CONNECT STM_PCONNECT
%token STM_NODE STM_NASS STM_INST KEYWORD_OF STM_DEFNAME STM_INVALID STM_PARAM STM_PREFIX STM_FORMAT STM_DEFAULT STM_WIDTH
...
%token EOF
%token M_UNDEFINED ASYNC RESET BRA_OPEN BRA_CLOSE FLIP EXPR_ASASYNC FULL STM_CONNECT0 STM_INVALID0 STM_REGRESET0 STM_MEM_INFER STM_MEM_READ STM_MEM_WRITE STM_SMEM
