...
firrtl.module @CarrySkipAdder(in %clock_wky: !firrtl.clock, in %reset_wky: !firrtl.uint<1>, in %io_a: !firrtl.uint<32>, in %io_b: !firrtl.uint<32>, in %io_cin: !firrtl.uint<1>, out %io_c: !firrtl.uint<32>, out %io_cout: !firrtl.uint<1>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %res_0, %_res_0_T : !firrtl.uint<4>
  ...
  firrtl.matchingconnect %couts_1, %_couts_1_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_1, %_res_1_T : !firrtl.uint<4>
  ...
  firrtl.matchingconnect %couts_2, %_couts_2_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_2, %_res_2_T : !firrtl.uint<4>
  ...
  firrtl.matchingconnect %couts_3, %_couts_3_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_3, %_res_3_T : !firrtl.uint<4>
  ...
  firrtl.matchingconnect %couts_4, %_couts_4_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_4, %_res_4_T : !firrtl.uint<4>
  ...
  firrtl.matchingconnect %couts_5, %_couts_5_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_5, %_res_5_T : !firrtl.uint<4>
  ...
  firrtl.matchingconnect %couts_6, %_couts_6_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_6, %_res_6_T : !firrtl.uint<4>
  ...
  firrtl.matchingconnect %couts_7, %_couts_7_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_7, %_res_7_T : !firrtl.uint<4>
  ...
  firrtl.matchingconnect %couts_8, %_couts_8_T_3 : !firrtl.uint<1>
