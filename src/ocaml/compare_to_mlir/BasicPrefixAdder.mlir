...
firrtl.module @BasicPrefixAdder(in %clock_wky: !firrtl.clock, in %reset_wky: !firrtl.uint<1>, in %io_a: !firrtl.uint<32>, in %io_b: !firrtl.uint<32>, in %io_cin: !firrtl.uint<1>, out %io_c: !firrtl.uint<32>, out %io_cout: !firrtl.uint<1>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %io_a_0, %io_a : !firrtl.uint<32>
  firrtl.matchingconnect %io_b_1, %io_b : !firrtl.uint<32>
  firrtl.matchingconnect %io_cin_2, %io_cin : !firrtl.uint<1>
  firrtl.matchingconnect %io_c, %io_c_3 : !firrtl.uint<32>
  firrtl.matchingconnect %io_cout, %io_cout_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_g, %_res_g_T : !firrtl.uint<1>
  %20 = firrtl.bits %a 0 to 0 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T = firrtl.node %20 : !firrtl.uint<1>
  firrtl.matchingconnect %res_a, %_res_a_T : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_1_g, %_res_g_T_1 : !firrtl.uint<1>
  %22 = firrtl.bits %a 1 to 1 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_1 = firrtl.node %22 : !firrtl.uint<1>
  firrtl.matchingconnect %res_1_a, %_res_a_T_1 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_2_g, %_res_g_T_2 : !firrtl.uint<1>
  %24 = firrtl.bits %a 2 to 2 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_2 = firrtl.node %24 : !firrtl.uint<1>
  firrtl.matchingconnect %res_2_a, %_res_a_T_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_3_g, %_res_g_T_3 : !firrtl.uint<1>
  %26 = firrtl.bits %a 3 to 3 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_3 = firrtl.node %26 : !firrtl.uint<1>
  firrtl.matchingconnect %res_3_a, %_res_a_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_4_g, %_res_g_T_4 : !firrtl.uint<1>
  %28 = firrtl.bits %a 4 to 4 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_4 = firrtl.node %28 : !firrtl.uint<1>
  firrtl.matchingconnect %res_4_a, %_res_a_T_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_5_g, %_res_g_T_5 : !firrtl.uint<1>
  %30 = firrtl.bits %a 5 to 5 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_5 = firrtl.node %30 : !firrtl.uint<1>
  firrtl.matchingconnect %res_5_a, %_res_a_T_5 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_6_g, %_res_g_T_6 : !firrtl.uint<1>
  %32 = firrtl.bits %a 6 to 6 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_6 = firrtl.node %32 : !firrtl.uint<1>
  firrtl.matchingconnect %res_6_a, %_res_a_T_6 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_7_g, %_res_g_T_7 : !firrtl.uint<1>
  %34 = firrtl.bits %a 7 to 7 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_7 = firrtl.node %34 : !firrtl.uint<1>
  firrtl.matchingconnect %res_7_a, %_res_a_T_7 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_8_g, %_res_g_T_8 : !firrtl.uint<1>
  %36 = firrtl.bits %a 8 to 8 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_8 = firrtl.node %36 : !firrtl.uint<1>
  firrtl.matchingconnect %res_8_a, %_res_a_T_8 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_9_g, %_res_g_T_9 : !firrtl.uint<1>
  %38 = firrtl.bits %a 9 to 9 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_9 = firrtl.node %38 : !firrtl.uint<1>
  firrtl.matchingconnect %res_9_a, %_res_a_T_9 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_10_g, %_res_g_T_10 : !firrtl.uint<1>
  %40 = firrtl.bits %a 10 to 10 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_10 = firrtl.node %40 : !firrtl.uint<1>
  firrtl.matchingconnect %res_10_a, %_res_a_T_10 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_11_g, %_res_g_T_11 : !firrtl.uint<1>
  %42 = firrtl.bits %a 11 to 11 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_11 = firrtl.node %42 : !firrtl.uint<1>
  firrtl.matchingconnect %res_11_a, %_res_a_T_11 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_12_g, %_res_g_T_12 : !firrtl.uint<1>
  %44 = firrtl.bits %a 12 to 12 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_12 = firrtl.node %44 : !firrtl.uint<1>
  firrtl.matchingconnect %res_12_a, %_res_a_T_12 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_13_g, %_res_g_T_13 : !firrtl.uint<1>
  %46 = firrtl.bits %a 13 to 13 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_13 = firrtl.node %46 : !firrtl.uint<1>
  firrtl.matchingconnect %res_13_a, %_res_a_T_13 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_14_g, %_res_g_T_14 : !firrtl.uint<1>
  %48 = firrtl.bits %a 14 to 14 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_14 = firrtl.node %48 : !firrtl.uint<1>
  firrtl.matchingconnect %res_14_a, %_res_a_T_14 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_15_g, %_res_g_T_15 : !firrtl.uint<1>
  %50 = firrtl.bits %a 15 to 15 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_15 = firrtl.node %50 : !firrtl.uint<1>
  firrtl.matchingconnect %res_15_a, %_res_a_T_15 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_16_g, %_res_g_T_16 : !firrtl.uint<1>
  %52 = firrtl.bits %a 16 to 16 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_16 = firrtl.node %52 : !firrtl.uint<1>
  firrtl.matchingconnect %res_16_a, %_res_a_T_16 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_17_g, %_res_g_T_17 : !firrtl.uint<1>
  %54 = firrtl.bits %a 17 to 17 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_17 = firrtl.node %54 : !firrtl.uint<1>
  firrtl.matchingconnect %res_17_a, %_res_a_T_17 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_18_g, %_res_g_T_18 : !firrtl.uint<1>
  %56 = firrtl.bits %a 18 to 18 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_18 = firrtl.node %56 : !firrtl.uint<1>
  firrtl.matchingconnect %res_18_a, %_res_a_T_18 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_19_g, %_res_g_T_19 : !firrtl.uint<1>
  %58 = firrtl.bits %a 19 to 19 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_19 = firrtl.node %58 : !firrtl.uint<1>
  firrtl.matchingconnect %res_19_a, %_res_a_T_19 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_20_g, %_res_g_T_20 : !firrtl.uint<1>
  %60 = firrtl.bits %a 20 to 20 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_20 = firrtl.node %60 : !firrtl.uint<1>
  firrtl.matchingconnect %res_20_a, %_res_a_T_20 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_21_g, %_res_g_T_21 : !firrtl.uint<1>
  %62 = firrtl.bits %a 21 to 21 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_21 = firrtl.node %62 : !firrtl.uint<1>
  firrtl.matchingconnect %res_21_a, %_res_a_T_21 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_22_g, %_res_g_T_22 : !firrtl.uint<1>
  %64 = firrtl.bits %a 22 to 22 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_22 = firrtl.node %64 : !firrtl.uint<1>
  firrtl.matchingconnect %res_22_a, %_res_a_T_22 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_23_g, %_res_g_T_23 : !firrtl.uint<1>
  %66 = firrtl.bits %a 23 to 23 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_23 = firrtl.node %66 : !firrtl.uint<1>
  firrtl.matchingconnect %res_23_a, %_res_a_T_23 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_24_g, %_res_g_T_24 : !firrtl.uint<1>
  %68 = firrtl.bits %a 24 to 24 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_24 = firrtl.node %68 : !firrtl.uint<1>
  firrtl.matchingconnect %res_24_a, %_res_a_T_24 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_25_g, %_res_g_T_25 : !firrtl.uint<1>
  %70 = firrtl.bits %a 25 to 25 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_25 = firrtl.node %70 : !firrtl.uint<1>
  firrtl.matchingconnect %res_25_a, %_res_a_T_25 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_26_g, %_res_g_T_26 : !firrtl.uint<1>
  %72 = firrtl.bits %a 26 to 26 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_26 = firrtl.node %72 : !firrtl.uint<1>
  firrtl.matchingconnect %res_26_a, %_res_a_T_26 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_27_g, %_res_g_T_27 : !firrtl.uint<1>
  %74 = firrtl.bits %a 27 to 27 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_27 = firrtl.node %74 : !firrtl.uint<1>
  firrtl.matchingconnect %res_27_a, %_res_a_T_27 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_28_g, %_res_g_T_28 : !firrtl.uint<1>
  %76 = firrtl.bits %a 28 to 28 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_28 = firrtl.node %76 : !firrtl.uint<1>
  firrtl.matchingconnect %res_28_a, %_res_a_T_28 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_29_g, %_res_g_T_29 : !firrtl.uint<1>
  %78 = firrtl.bits %a 29 to 29 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_29 = firrtl.node %78 : !firrtl.uint<1>
  firrtl.matchingconnect %res_29_a, %_res_a_T_29 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_30_g, %_res_g_T_30 : !firrtl.uint<1>
  %80 = firrtl.bits %a 30 to 30 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_30 = firrtl.node %80 : !firrtl.uint<1>
  firrtl.matchingconnect %res_30_a, %_res_a_T_30 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_31_g, %_res_g_T_31 : !firrtl.uint<1>
  %82 = firrtl.bits %a 31 to 31 : (!firrtl.uint<32>) -> !firrtl.uint<1>
  %_res_a_T_31 = firrtl.node %82 : !firrtl.uint<1>
  firrtl.matchingconnect %res_31_a, %_res_a_T_31 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_32_g, %_res_g_T_33 : !firrtl.uint<1>
  %89 = firrtl.and %res_2_a, %res_1_a : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
  %_res_a_T_32 = firrtl.node %89 : !firrtl.uint<1>
  firrtl.matchingconnect %res_32_a, %_res_a_T_32 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_33_g, %_res_g_T_35 : !firrtl.uint<1>
  %92 = firrtl.and %res_4_a, %res_3_a : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
  %_res_a_T_33 = firrtl.node %92 : !firrtl.uint<1>
  firrtl.matchingconnect %res_33_a, %_res_a_T_33 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_34_g, %_res_g_T_37 : !firrtl.uint<1>
  %95 = firrtl.and %res_6_a, %res_5_a : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
  %_res_a_T_34 = firrtl.node %95 : !firrtl.uint<1>
  firrtl.matchingconnect %res_34_a, %_res_a_T_34 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_35_g, %_res_g_T_39 : !firrtl.uint<1>
  %98 = firrtl.and %res_8_a, %res_7_a : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
  %_res_a_T_35 = firrtl.node %98 : !firrtl.uint<1>
  firrtl.matchingconnect %res_35_a, %_res_a_T_35 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_36_g, %_res_g_T_41 : !firrtl.uint<1>
  %101 = firrtl.and %res_10_a, %res_9_a : (!firrtl.uint<1>, !firrtl.uint<1>) -> !firrtl.uint<1>
  %_res_a_T_36 = firrtl.node %101 : !firrtl.uint<1>
  firrtl.matchingconnect %res_36_a, %_res_a_T_36 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %_cs_WIRE_0, %io_cin_2 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_1, %86 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_2, %135 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_3, %139 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_4, %143 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_5, %147 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_6, %151 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_7, %155 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_8, %159 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_9, %163 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_10, %167 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_11, %171 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_12, %175 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_13, %179 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_14, %183 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_15, %187 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_16, %191 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_17, %195 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_18, %199 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_19, %203 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_20, %207 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_21, %211 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_22, %215 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_23, %219 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_24, %223 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_25, %227 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_26, %231 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_27, %235 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_28, %239 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_29, %243 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_30, %247 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_31, %251 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_32, %255 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %io_c_3, %_io_c_T_1 : !firrtl.uint<32>
  %290 = firrtl.bits %cs 32 to 32 : (!firrtl.uint<33>) -> !firrtl.uint<1>
  %_io_cout_T = firrtl.node %290 : !firrtl.uint<1>
  firrtl.matchingconnect %io_cout_4, %_io_cout_T : !firrtl.uint<1>
}
