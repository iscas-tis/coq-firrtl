...
firrtl.module @BcdTable(in %clock_wky: !firrtl.clock, in %reset_wky: !firrtl.uint<1>, in %io_address: !firrtl.uint<8>, out %io_data: !firrtl.uint<8>) attributes {convention = #firrtl<convention scalarized>} {
  %io_address_0 = firrtl.wire {name = "io_address"} : !firrtl.uint<8>
  %io_data_1 = firrtl.wire {name = "io_data"} : !firrtl.uint<8>
  firrtl.matchingconnect %io_address_0, %io_address : !firrtl.uint<8>
  firrtl.matchingconnect %io_data, %io_data_1 : !firrtl.uint<8>
  ...
  firrtl.matchingconnect %io_data_1, %81 : !firrtl.uint<8>
}
