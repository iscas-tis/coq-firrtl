...
firrtl.module @FunctionalAdd(in %clock: !firrtl.clock, in %reset1: !firrtl.uint<1>, in %io_in_0: !firrtl.uint<10>, in %io_in_1: !firrtl.uint<10>, in %io_in_2: !firrtl.uint<10>, in %io_in_3: !firrtl.uint<10>, in %io_in_4: !firrtl.uint<10>, out %io_res: !firrtl.uint<10>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %io_in_0_0, %io_in_0 : !firrtl.uint<10>
  firrtl.matchingconnect %io_in_1_1, %io_in_1 : !firrtl.uint<10>
  firrtl.matchingconnect %io_in_2_2, %io_in_2 : !firrtl.uint<10>
  firrtl.matchingconnect %io_in_3_3, %io_in_3 : !firrtl.uint<10>
  firrtl.matchingconnect %io_in_4_4, %io_in_4 : !firrtl.uint<10>
  firrtl.matchingconnect %io_res, %io_res_5 : !firrtl.uint<10>
  ...
  firrtl.matchingconnect %io_res_5, %sum : !firrtl.uint<10>
}
