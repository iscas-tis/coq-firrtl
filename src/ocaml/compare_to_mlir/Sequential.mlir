...
firrtl.module @Sequential(in %clock: !firrtl.clock, in %reset1: !firrtl.uint<1>, in %io_d: !firrtl.uint<4>, out %io_q: !firrtl.uint<4>, in %io_d2: !firrtl.uint<4>, out %io_q2: !firrtl.uint<4>, in %io_d3: !firrtl.uint<4>, out %io_q3: !firrtl.uint<4>, in %io_ena: !firrtl.uint<1>, out %io_q4: !firrtl.uint<4>, out %io_q5: !firrtl.uint<4>, out %io_q6: !firrtl.uint<4>, out %io_q7: !firrtl.uint<4>, in %io_riseIn: !firrtl.uint<1>, out %io_riseOut: !firrtl.uint<1>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %io_d_0, %io_d : !firrtl.uint<4>
  firrtl.matchingconnect %io_q, %io_q_1 : !firrtl.uint<4>
  firrtl.matchingconnect %io_d2_2, %io_d2 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q2, %io_q2_3 : !firrtl.uint<4>
  firrtl.matchingconnect %io_d3_4, %io_d3 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q3, %io_q3_5 : !firrtl.uint<4>
  firrtl.matchingconnect %io_ena_6, %io_ena : !firrtl.uint<1>
  firrtl.matchingconnect %io_q4, %io_q4_7 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q5, %io_q5_8 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q6, %io_q6_9 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q7, %io_q7_10 : !firrtl.uint<4>
  firrtl.matchingconnect %io_riseIn_11, %io_riseIn : !firrtl.uint<1>
  firrtl.matchingconnect %io_riseOut, %io_riseOut_12 : !firrtl.uint<1>
  %c0_ui1 = firrtl.constant 0 : !firrtl.uint<1>
  %q = firrtl.reg %clock : !firrtl.clock, !firrtl.uint<4>
  firrtl.matchingconnect %q, %io_d_0 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q_1, %q : !firrtl.uint<4>
  %delayReg = firrtl.reg %clock : !firrtl.clock, !firrtl.uint<4>
  firrtl.matchingconnect %delayReg, %io_d2_2 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q2_3, %delayReg : !firrtl.uint<4>
  %c0_ui4 = firrtl.constant 0 : !firrtl.uint<4>
  %valReg = firrtl.regreset %clock, %reset1, %c0_ui4 : !firrtl.clock, !firrtl.uint<1>, !firrtl.uint<4>, !firrtl.uint<4>
  firrtl.matchingconnect %valReg, %io_d3_4 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q3_5, %valReg : !firrtl.uint<4>
  ...
  firrtl.connect %enableReg, %0 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q4_7, %enableReg : !firrtl.uint<4>
  ...
  firrtl.connect %resetEnableReg, %1 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q5_8, %resetEnableReg : !firrtl.uint<4>
  ...
  firrtl.connect %enableReg2, %2 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q6_9, %enableReg2 : !firrtl.uint<4>
  ...
  firrtl.connect %resetEnableReg2, %3 : !firrtl.uint<4>
  firrtl.matchingconnect %io_q7_10, %resetEnableReg2 : !firrtl.uint<4>
  %risingEdge_REG = firrtl.reg %clock : !firrtl.clock, !firrtl.uint<1>
  firrtl.matchingconnect %risingEdge_REG, %io_riseIn_11 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %io_riseOut_12, %risingEdge : !firrtl.uint<1>
}
