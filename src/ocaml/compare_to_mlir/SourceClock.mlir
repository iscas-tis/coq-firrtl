...
firrtl.module @SourceClock(in %clock: !firrtl.clock, in %reset1: !firrtl.uint<1>, out %io_c_data: !firrtl.uint<32>, out %io_c_valid: !firrtl.uint<1>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %io_c_data, %io_c_data_0 : !firrtl.uint<32>
  firrtl.matchingconnect %io_c_valid, %io_c_valid_1 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %io_c_valid_1, %valid : !firrtl.uint<1>
  firrtl.matchingconnect %io_c_data_0, %cntReg : !firrtl.uint<32>
}
