...
firrtl.module @CarryLookaheadAdder(in %clock_wky: !firrtl.clock, in %reset_wky: !firrtl.uint<1>, in %io_a: !firrtl.uint<32>, in %io_b: !firrtl.uint<32>, in %io_cin: !firrtl.uint<1>, out %io_c: !firrtl.uint<32>, out %io_cout: !firrtl.uint<1>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %couts_0, %io_cin_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_0, %couts_0 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_1, %_cs_1_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_2, %_cs_2_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_3, %_cs_3_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_4, %_cs_4_T_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_0, %_res_0_T_2 : !firrtl.uint<4>
  firrtl.matchingconnect %couts_1, %cs_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_1_0, %couts_1 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_1_1, %_cs_1_T_7 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_1_2, %_cs_2_T_7 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_1_3, %_cs_3_T_7 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_1_4, %_cs_4_T_7 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_1, %_res_1_T_2 : !firrtl.uint<4>
  firrtl.matchingconnect %couts_2, %cs_1_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_2_0, %couts_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_2_1, %_cs_1_T_11 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_2_2, %_cs_2_T_11 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_2_3, %_cs_3_T_11 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_2_4, %_cs_4_T_11 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_2, %_res_2_T_2 : !firrtl.uint<4>
  firrtl.matchingconnect %couts_3, %cs_2_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_3_0, %couts_3 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_3_1, %_cs_1_T_15 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_3_2, %_cs_2_T_15 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_3_3, %_cs_3_T_15 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_3_4, %_cs_4_T_15 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_3, %_res_3_T_2 : !firrtl.uint<4>
  firrtl.matchingconnect %couts_4, %cs_3_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_4_0, %couts_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_4_1, %_cs_1_T_19 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_4_2, %_cs_2_T_19 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_4_3, %_cs_3_T_19 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_4_4, %_cs_4_T_19 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_4, %_res_4_T_2 : !firrtl.uint<4>
  firrtl.matchingconnect %couts_5, %cs_4_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_5_0, %couts_5 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_5_1, %_cs_1_T_23 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_5_2, %_cs_2_T_23 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_5_3, %_cs_3_T_23 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_5_4, %_cs_4_T_23 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_5, %_res_5_T_2 : !firrtl.uint<4>
  firrtl.matchingconnect %couts_6, %cs_5_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_6_0, %couts_6 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_6_1, %_cs_1_T_27 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_6_2, %_cs_2_T_27 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_6_3, %_cs_3_T_27 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_6_4, %_cs_4_T_27 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_6, %_res_6_T_2 : !firrtl.uint<4>
  firrtl.matchingconnect %couts_7, %cs_6_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_7_0, %couts_7 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_7_1, %_cs_1_T_31 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_7_2, %_cs_2_T_31 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_7_3, %_cs_3_T_31 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %cs_7_4, %_cs_4_T_31 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %res_7, %_res_7_T_2 : !firrtl.uint<4>
  firrtl.matchingconnect %couts_8, %cs_7_4 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %io_cout_4, %couts_8 : !firrtl.uint<1>
}
