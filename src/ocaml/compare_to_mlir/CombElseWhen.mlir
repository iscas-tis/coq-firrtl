...
firrtl.module @CombElseWhen(in %clock: !firrtl.clock, in %reset1: !firrtl.uint<1>, in %io_cond: !firrtl.uint<1>, in %io_cond2: !firrtl.uint<1>, out %io_out: !firrtl.uint<4>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %io_cond2_1, %io_cond2 : !firrtl.uint<1>
  firrtl.matchingconnect %io_out, %io_out_2 : !firrtl.uint<4>
  ...
  firrtl.connect %w, %5 : !firrtl.uint<2>
