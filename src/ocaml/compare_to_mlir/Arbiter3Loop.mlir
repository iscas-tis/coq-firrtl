...
firrtl.module @Arbiter3Loop(in %clock_wky: !firrtl.clock, in %reset1: !firrtl.uint<1>, in %io_request: !firrtl.uint<3>, out %io_grant: !firrtl.uint<3>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %notGranted_2, %_notGranted_2_T_1 : !firrtl.uint<1>
