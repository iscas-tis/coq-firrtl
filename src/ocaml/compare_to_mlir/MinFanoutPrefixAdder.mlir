...
firrtl.module @MinFanoutPrefixAdder(in %clock: !firrtl.clock, in %reset_wky: !firrtl.uint<1>, in %io_a: !firrtl.uint<32>, in %io_b: !firrtl.uint<32>, in %io_cin: !firrtl.uint<1>, out %io_c: !firrtl.uint<32>, out %io_cout: !firrtl.uint<1>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %_cs_WIRE_2, %90 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_3, %94 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_4, %98 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_5, %102 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_6, %106 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_7, %110 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_8, %114 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_9, %118 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_10, %122 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_11, %126 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_12, %130 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_13, %134 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_14, %138 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_15, %142 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_16, %146 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_17, %150 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_18, %154 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_19, %158 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_20, %162 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_21, %166 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_22, %170 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_23, %174 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_24, %178 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_25, %182 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_26, %186 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_27, %190 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_28, %194 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_29, %198 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_30, %202 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_31, %206 : !firrtl.uint<1>
  firrtl.matchingconnect %_cs_WIRE_32, %210 : !firrtl.uint<1>
