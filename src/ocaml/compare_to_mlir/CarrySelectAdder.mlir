...
firrtl.module @CarrySelectAdder(in %clock_wky: !firrtl.clock, in %reset_wky: !firrtl.uint<1>, in %io_a: !firrtl.uint<32>, in %io_b: !firrtl.uint<32>, in %io_cin: !firrtl.uint<1>, out %io_c: !firrtl.uint<32>, out %io_cout: !firrtl.uint<1>) attributes {convention = #firrtl<convention scalarized>} {
  ...
  firrtl.matchingconnect %couts_1, %_couts_1_T_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %couts_2, %_couts_2_T_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %couts_3, %_couts_3_T_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %couts_4, %_couts_4_T_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %couts_5, %_couts_5_T_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %couts_6, %_couts_6_T_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %couts_7, %_couts_7_T_2 : !firrtl.uint<1>
  ...
  firrtl.matchingconnect %couts_8, %_couts_8_T_2 : !firrtl.uint<1>
