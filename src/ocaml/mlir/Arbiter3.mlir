...
firrtl.module @Arbiter3(in %clock1: !firrtl.clock, in %reset1: !firrtl.uint<1>, in %io_request: !firrtl.uint<3>, out %io_grant: !firrtl.uint<3>) attributes {convention = #firrtl<convention scalarized>} {
