...
firrtl.module @SimpleFsm(in %clock: !firrtl.clock, in %reset1: !firrtl.uint<1>, in %io_badEvent: !firrtl.uint<1>, in %io_clear: !firrtl.uint<1>, out %io_ringBell: !firrtl.uint<1>) attributes {convention = #firrtl<convention scalarized>} {
